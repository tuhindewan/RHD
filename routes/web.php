...
//Profile data entry
Route::get('/user/info', [InformationController::class, 'create'])->name('user.info.form');
Route::put('/user/info/{user}', [InformationController::class, 'update'])->name('user.info.form.update');
