<div class="tab">
    <div class="row">
        ...
        <div class="col-md-12">
            <h5 style="text-align: center">জমি (কৃষি/অকৃষি)</h5>
            <div class="row">
                <div class="col-md-4">
        ...
        <div class="col-md-12">
            <h5 style="text-align: center">ইমারত</h5>
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
        ...
        <div class="col-md-12">
            <h5 style="text-align: center">বসতবাড়ি</h5>
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
        ...
        <div class="col-md-12">
            <h5 style="text-align: center">ব্যবসা প্রতিষ্ঠান</h5>
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
