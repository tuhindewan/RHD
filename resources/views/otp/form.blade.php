...
<head>
    ...
    <link rel="icon" href="{{ asset('images/img/ictd1.png') }}" type="image/gif">
    ...
    <style>
        ...
        #loginPage {
            background-image: url("{{ asset('images/img/get.jpeg') }}");
    ...
    <div class="container-fluid">
        <div class="row justify-content-center align-items-center min-vh-100 ">
            <div class="card text-center">
                ...
                <form method="POST" action="{{ route('post.otp.form') }}">
                    @csrf
                    <div class="form-group">
                        <input id="code" name="code" type="text"
                               class="form-control{{ $errors->has('code') ? ' is-invalid' : '' }}"
                               aria-describedby="codeHelp" placeholder="Enter OTP"
